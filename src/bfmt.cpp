...
namespace bond{
    ...
    auto write_function(std::ofstream& stream, Function *function) -> void {
        ...
        auto arguments = function->get_params();
    ...
    auto read_function(std::ifstream& stream) -> GcPtr<Function> {
        ...
        return GarbageCollector::instance().make_immortal<Function>(code, params, name);
    }
    ...
    auto write_struct(std::ofstream& stream, Struct *s) -> void {
        ...
        auto fields = s->get_instance_variables();
        auto methods = s->get_methods()->get_map();
    ...
    auto read_code_impl(std::ifstream &stream) -> GcPtr<Code> {
        ...
        auto constants = std::vector<GcPtr<Object>>();
        auto lock = LockGc();
