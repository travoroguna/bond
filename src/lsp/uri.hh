...
private:
    ...
    void setup(std::string const &uri_text, [[maybe_unused]]scheme_category category) {
    ...
    std::string::const_iterator parse_username(std::string const &uri_text,
                                               [[maybe_unused]]std::string const &content,
    ...
    void init_query_dictionary() {
        if (!m_query.empty()) {
            ...
            do {
                std::string stanza = m_query.substr(carat, ((stanza_end != std::string::npos) ? (stanza_end - carat)
                                                                                              : std::string::npos));
