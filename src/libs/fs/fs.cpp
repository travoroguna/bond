...
namespace bond::fs {
    static obj_result exists(const t_vector &args) {
        ...
        return AS_BOOL(std::filesystem::exists(path->get_value()));
    }
    ...
    static obj_result full_path(const t_vector &args) {
        ...
        return make_ok_t(std::filesystem::absolute(path->get_value()).string());
    }
    ...
    static obj_result is_dir(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::is_directory(path->get_value())));
    }
    ...
    static obj_result is_file(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::is_regular_file(path->get_value())));
    }
    ...
    static obj_result is_symlink(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::is_symlink(path->get_value())));
    }
    ...
    static obj_result is_empty(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::is_empty(path->get_value())));
    }
    ...
    static obj_result is_relative(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::path(path->get_value()).is_relative()));
    }
    ...
    static obj_result is_absolute(const t_vector &args) {
        ...
        return make_ok(AS_BOOL(std::filesystem::path(path->get_value()).is_absolute()));
    }
    ...
    static obj_result set_cwd(const t_vector &args) {
        ...
        std::filesystem::current_path(path->get_value());
