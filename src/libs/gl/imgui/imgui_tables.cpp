...
ImGui::BeginTableEx(const char *name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2 &outer_size,
    ...
    if (instance_no > 0) {
        ...
        instance_id = GetIDWithSeed(instance_no, GetIDWithSeed("##Instances", NULL,
...
void ImGui::TableSetupDrawChannels(ImGuiTable *table) {
    ...
    const int channels_for_dummy = (table->ColumnsEnabledCount < table->ColumnsCount ||
                                    (memcmp(table->VisibleMaskByIndex, table->EnabledMaskByIndex,
                                            ImBitArrayGetStorageSizeInBytes(table->ColumnsCount)) != 0)) ? +1 : 0;
...
void ImGui::TableMergeDrawChannels(ImGuiTable *table) {
    ...
    for (int n = 0; n < IM_ARRAYSIZE(merge_groups); n++)
        merge_groups[n].ChannelsMask = (ImBitArrayPtr) (void *) (g.TempBuffer.Data +
