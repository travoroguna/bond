...
// Read gl.cpp for more details, documentation and comments.
...
//   by gl.h using the IMGUI_DEFINE_MATH_OPERATORS define. For your own sources file they are optional
...
// In other gl sources we can use nicer internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool *p_open) {
    ...
    IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear gl context. Refer to examples app!");
    ...
    ImGui::Text("dear gl says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help")) {
        ...
        ImGui::BulletText("See comments in gl.cpp.");
...
static void ShowDemoWindowWidgets() {
        ...
        if (ImGui::TreeNode("Filtered Text Input")) {
            struct TextFilters {
                ...
                static int FilterImGuiLetters(ImGuiInputTextCallbackData *data) {
                    if (data->EventChar < 256 && strchr("gl", (char) data->EventChar))
                        return 0;
                    return 1;
                }
            };
            ...
            static char buf6[64] = "";
            ImGui::InputText("\"gl\" letters", buf6, 64, ImGuiInputTextFlags_CallbackCharFilter,
    ...
    if (ImGui::TreeNode("Data Types")) {
        ...
        ImGui::SameLine();
        HelpMarker(
                "As with every widget in dear gl, we never modify values unless there is a user interaction.\n"
...
static void ShowDemoWindowPopups() {
    ...
    if (ImGui::TreeNode("Modals")) {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar)) {
            ...
            // will close the popup. Note that the visibility state of popups is owned by gl, so the input value
...
// If you don't use sorting, you will generally never care about giving column an ID!
    ...
    struct MyItem {
        ...
        // As we don't rely on std:: or other third-party library to compile dear gl, we only have reliable access to qsort(),
...
static void ShowExampleAppCustomRendering(bool *p_open) {
    ...
    // types and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to gl.cpp and not
