// dear gl: Platform Backend for GLFW
...
//   (passing install_callbacks=false in ImGui_ImplGlfw_InitXXX functions), set the current dear gl context and then call our callbacks.
...
static void ImGui_ImplGlfw_UpdateMouseCursor() {
    ...
    // (those braces are here to reduce diff with multi-viewports support in 'docking' branch)
    {
        ...
        if (imgui_cursor == ImGuiMouseCursor_None || io.MouseDrawCursor) {
            // Hide OS mouse cursor if gl is drawing it or if it wants no cursor
