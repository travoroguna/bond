...
#define make_color(NAME) { #NAME, m_gc->make_immortal<bond::raylib::Color>( ::NAME ) }
    ...
    std::unordered_map<std::string, GcPtr<Object>> ray_font = {
            {"get_font_default",       m_gc->make_immortal<NativeFunction>(get_font_default, "get_font_default")},
            {"load_font",              m_gc->make_immortal<NativeFunction>(load_font, "load_font")},
            {"load_font_ex",           m_gc->make_immortal<NativeFunction>(load_font_ex, "load_font_ex")},
            {"load_font_from_image",   m_gc->make_immortal<NativeFunction>(load_font_from_image,
                                                                           "load_font_from_image")},
            {"load_font_from_memory",  m_gc->make_immortal<NativeFunction>(load_font_from_memory,
                                                                           "load_font_from_memory")},
            {"is_font_ready",          m_gc->make_immortal<NativeFunction>(is_font_ready, "is_font_ready")},
            {"load_font_data",         m_gc->make_immortal<NativeFunction>(load_font_data, "load_font_data")},
            {"gen_image_font_atlas",   m_gc->make_immortal<NativeFunction>(gen_image_font_atlas,
                                                                           "gen_image_font_atlas")},
            {"unload_font_data",       m_gc->make_immortal<NativeFunction>(unload_font_data, "unload_font_data")},
            {"unload_font",            m_gc->make_immortal<NativeFunction>(unload_font, "unload_font")},
            {"export_font_as_code",    m_gc->make_immortal<NativeFunction>(export_font_as_code, "export_font_as_code")},
            {"draw_fps",               m_gc->make_immortal<NativeFunction>(draw_fps, "draw_fps")},
            {"draw_text",              m_gc->make_immortal<NativeFunction>(draw_text, "draw_text")},
            {"draw_text_ex",           m_gc->make_immortal<NativeFunction>(draw_text_ex, "draw_text_ex")},
            {"draw_text_pro",          m_gc->make_immortal<NativeFunction>(draw_text_pro, "draw_text_pro")},
            {"draw_text_codepoint",    m_gc->make_immortal<NativeFunction>(draw_text_codepoint, "draw_text_codepoint")},
            {"draw_text_codepoints",   m_gc->make_immortal<NativeFunction>(draw_text_codepoints,
                                                                           "draw_text_codepoints")},
            {"measure_text",           m_gc->make_immortal<NativeFunction>(measure_text, "measure_text")},
            {"measure_text_ex",        m_gc->make_immortal<NativeFunction>(measure_text_ex, "measure_text_ex")},
            {"get_glyph_index",        m_gc->make_immortal<NativeFunction>(get_glyph_index, "get_glyph_index")},
            {"get_glyph_info",         m_gc->make_immortal<NativeFunction>(get_glyph_info, "get_glyph_info")},
            {"get_glyph_atlas_rec",    m_gc->make_immortal<NativeFunction>(get_glyph_atlas_rec, "get_glyph_atlas_rec")},
            {"load_utf8",              m_gc->make_immortal<NativeFunction>(load_utf8, "load_utf8")},
            {"unload_utf8",            m_gc->make_immortal<NativeFunction>(unload_utf8, "unload_utf8")},
            {"load_codepoints",        m_gc->make_immortal<NativeFunction>(load_codepoints, "load_codepoints")},
            {"unload_codepoints",      m_gc->make_immortal<NativeFunction>(unload_codepoints, "unload_codepoints")},
            {"get_codepoint_count",    m_gc->make_immortal<NativeFunction>(get_codepoint_count, "get_codepoint_count")},
            {"get_codepoint",          m_gc->make_immortal<NativeFunction>(get_codepoint, "get_codepoint")},
            {"get_codepoint_next",     m_gc->make_immortal<NativeFunction>(get_codepoint_next, "get_codepoint_next")},
            {"get_codepoint_previous", m_gc->make_immortal<NativeFunction>(get_codepoint_previous,
                                                                           "get_codepoint_previous")},
            {"codepoint_to_utf8",      m_gc->make_immortal<NativeFunction>(codepoint_to_utf8, "codepoint_to_utf8")},
            {"text_copy",              m_gc->make_immortal<NativeFunction>(text_copy, "text_copy")},
            {"text_is_equal",          m_gc->make_immortal<NativeFunction>(text_is_equal, "text_is_equal")},
            {"text_length",            m_gc->make_immortal<NativeFunction>(text_length, "text_length")},
            {"text_format",            m_gc->make_immortal<NativeFunction>(text_format, "text_format")},
            {"text_subtext",           m_gc->make_immortal<NativeFunction>(text_subtext, "text_subtext")},
            {"text_replace",           m_gc->make_immortal<NativeFunction>(text_replace, "text_replace")},
            {"text_insert",            m_gc->make_immortal<NativeFunction>(text_insert, "text_insert")},
            {"text_join",              m_gc->make_immortal<NativeFunction>(text_join, "text_join")},
            {"text_split",             m_gc->make_immortal<NativeFunction>(text_split, "text_split")},
            {"text_append",            m_gc->make_immortal<NativeFunction>(text_append, "text_append")},
            {"text_find_index",        m_gc->make_immortal<NativeFunction>(text_find_index, "text_find_index")},
            {"text_to_upper",          m_gc->make_immortal<NativeFunction>(text_to_upper, "text_to_upper")},
            {"text_to_lower",          m_gc->make_immortal<NativeFunction>(text_to_lower, "text_to_lower")},
            {"text_to_pascal",         m_gc->make_immortal<NativeFunction>(text_to_pascal, "text_to_pascal")},
            {"text_to_integer",        m_gc->make_immortal<NativeFunction>(text_to_integer, "text_to_integer")}
    };

    std::unordered_map<std::string, GcPtr<Object>> ray_audio = {
            {"init_audio_device",                    m_gc->make_immortal<NativeFunction>(init_audio_device,
                                                                                         "init_audio_device")},
            {"close_audio_device",                   m_gc->make_immortal<NativeFunction>(close_audio_device,
                                                                                         "close_audio_device")},
            {"is_audio_device_ready",                m_gc->make_immortal<NativeFunction>(is_audio_device_ready,
                                                                                         "is_audio_device_ready")},
            {"set_master_volume",                    m_gc->make_immortal<NativeFunction>(set_master_volume,
                                                                                         "set_master_volume")},
            {"load_wave",                            m_gc->make_immortal<NativeFunction>(load_wave, "load_wave")},
            {"load_wave_from_memory",                m_gc->make_immortal<NativeFunction>(load_wave_from_memory,
                                                                                         "load_wave_from_memory")},
            {"is_wave_ready",                        m_gc->make_immortal<NativeFunction>(is_wave_ready,
                                                                                         "is_wave_ready")},
            {"load_sound",                           m_gc->make_immortal<NativeFunction>(load_sound, "load_sound")},
            {"load_sound_from_wave",                 m_gc->make_immortal<NativeFunction>(load_sound_from_wave,
                                                                                         "load_sound_from_wave")},
            {"is_sound_ready",                       m_gc->make_immortal<NativeFunction>(is_sound_ready,
                                                                                         "is_sound_ready")},
            {"update_sound",                         m_gc->make_immortal<NativeFunction>(update_sound, "update_sound")},
            {"unload_wave",                          m_gc->make_immortal<NativeFunction>(unload_wave, "unload_wave")},
            {"unload_sound",                         m_gc->make_immortal<NativeFunction>(unload_sound, "unload_sound")},
            {"export_wave",                          m_gc->make_immortal<NativeFunction>(export_wave, "export_wave")},
            {"export_wave_as_code",                  m_gc->make_immortal<NativeFunction>(export_wave_as_code,
                                                                                         "export_wave_as_code")},
            {"play_sound",                           m_gc->make_immortal<NativeFunction>(play_sound, "play_sound")},
            {"stop_sound",                           m_gc->make_immortal<NativeFunction>(stop_sound, "stop_sound")},
            {"pause_sound",                          m_gc->make_immortal<NativeFunction>(pause_sound, "pause_sound")},
            {"resume_sound",                         m_gc->make_immortal<NativeFunction>(resume_sound, "resume_sound")},
            {"is_sound_playing",                     m_gc->make_immortal<NativeFunction>(is_sound_playing,
                                                                                         "is_sound_playing")},
            {"set_sound_volume",                     m_gc->make_immortal<NativeFunction>(set_sound_volume,
                                                                                         "set_sound_volume")},
            {"set_sound_pitch",                      m_gc->make_immortal<NativeFunction>(set_sound_pitch,
                                                                                         "set_sound_pitch")},
            {"set_sound_pan",                        m_gc->make_immortal<NativeFunction>(set_sound_pan,
                                                                                         "set_sound_pan")},
            {"wave_copy",                            m_gc->make_immortal<NativeFunction>(wave_copy, "wave_copy")},
            {"wave_crop",                            m_gc->make_immortal<NativeFunction>(wave_crop, "wave_crop")},
            {"wave_format",                          m_gc->make_immortal<NativeFunction>(wave_format, "wave_format")},
            {"load_wave_samples",                    m_gc->make_immortal<NativeFunction>(load_wave_samples,
                                                                                         "load_wave_samples")},
            {"unload_wave_samples",                  m_gc->make_immortal<NativeFunction>(unload_wave_samples,
                                                                                         "unload_wave_samples")},
            {"load_music_stream",                    m_gc->make_immortal<NativeFunction>(load_music_stream,
                                                                                         "load_music_stream")},
            {"load_music_stream_from_memory",        m_gc->make_immortal<NativeFunction>(load_music_stream_from_memory,
                                                                                         "load_music_stream_from_memory")},
            {"is_music_ready",                       m_gc->make_immortal<NativeFunction>(is_music_ready,
                                                                                         "is_music_ready")},
            {"unload_music_stream",                  m_gc->make_immortal<NativeFunction>(unload_music_stream,
                                                                                         "unload_music_stream")},
            {"play_music_stream",                    m_gc->make_immortal<NativeFunction>(play_music_stream,
                                                                                         "play_music_stream")},
            {"is_music_stream_playing",              m_gc->make_immortal<NativeFunction>(is_music_stream_playing,
                                                                                         "is_music_stream_playing")},
            {"update_music_stream",                  m_gc->make_immortal<NativeFunction>(update_music_stream,
                                                                                         "update_music_stream")},
            {"stop_music_stream",                    m_gc->make_immortal<NativeFunction>(stop_music_stream,
                                                                                         "stop_music_stream")},
            {"pause_music_stream",                   m_gc->make_immortal<NativeFunction>(pause_music_stream,
                                                                                         "pause_music_stream")},
            {"resume_music_stream",                  m_gc->make_immortal<NativeFunction>(resume_music_stream,
                                                                                         "resume_music_stream")},
            {"seek_music_stream",                    m_gc->make_immortal<NativeFunction>(seek_music_stream,
                                                                                         "seek_music_stream")},
            {"set_music_volume",                     m_gc->make_immortal<NativeFunction>(set_music_volume,
                                                                                         "set_music_volume")},
            {"set_music_pitch",                      m_gc->make_immortal<NativeFunction>(set_music_pitch,
                                                                                         "set_music_pitch")},
            {"set_music_pan",                        m_gc->make_immortal<NativeFunction>(set_music_pan,
                                                                                         "set_music_pan")},
            {"get_music_time_length",                m_gc->make_immortal<NativeFunction>(get_music_time_length,
                                                                                         "get_music_time_length")},
            {"get_music_time_played",                m_gc->make_immortal<NativeFunction>(get_music_time_played,
                                                                                         "get_music_time_played")},
            {"load_audio_stream",                    m_gc->make_immortal<NativeFunction>(load_audio_stream,
                                                                                         "load_audio_stream")},
            {"is_audio_stream_ready",                m_gc->make_immortal<NativeFunction>(is_audio_stream_ready,
                                                                                         "is_audio_stream_ready")},
            {"unload_audio_stream",                  m_gc->make_immortal<NativeFunction>(unload_audio_stream,
                                                                                         "unload_audio_stream")},
            {"update_audio_stream",                  m_gc->make_immortal<NativeFunction>(update_audio_stream,
                                                                                         "update_audio_stream")},
            {"is_audio_stream_processed",            m_gc->make_immortal<NativeFunction>(is_audio_stream_processed,
                                                                                         "is_audio_stream_processed")},
            {"play_audio_stream",                    m_gc->make_immortal<NativeFunction>(play_audio_stream,
                                                                                         "play_audio_stream")},
            {"pause_audio_stream",                   m_gc->make_immortal<NativeFunction>(pause_audio_stream,
                                                                                         "pause_audio_stream")},
            {"resume_audio_stream",                  m_gc->make_immortal<NativeFunction>(resume_audio_stream,
                                                                                         "resume_audio_stream")},
            {"is_audio_stream_playing",              m_gc->make_immortal<NativeFunction>(is_audio_stream_playing,
                                                                                         "is_audio_stream_playing")},
            {"stop_audio_stream",                    m_gc->make_immortal<NativeFunction>(stop_audio_stream,
                                                                                         "stop_audio_stream")},
            {"set_audio_stream_volume",              m_gc->make_immortal<NativeFunction>(set_audio_stream_volume,
                                                                                         "set_audio_stream_volume")},
            {"set_audio_stream_pitch",               m_gc->make_immortal<NativeFunction>(set_audio_stream_pitch,
                                                                                         "set_audio_stream_pitch")},
            {"set_audio_stream_pan",                 m_gc->make_immortal<NativeFunction>(set_audio_stream_pan,
                                                                                         "set_audio_stream_pan")},
            {"set_audio_stream_buffer_size_default", m_gc->make_immortal<NativeFunction>(
                    set_audio_stream_buffer_size_default, "set_audio_stream_buffer_size_default")},
            {"set_audio_stream_callback",            m_gc->make_immortal<NativeFunction>(set_audio_stream_callback,
                                                                                         "set_audio_stream_callback")},
            {"attach_audio_stream_processor",        m_gc->make_immortal<NativeFunction>(attach_audio_stream_processor,
                                                                                         "attach_audio_stream_processor")},
            {"detach_audio_stream_processor",        m_gc->make_immortal<NativeFunction>(detach_audio_stream_processor,
                                                                                         "detach_audio_stream_processor")},
            {"attach_audio_mixed_processor",         m_gc->make_immortal<NativeFunction>(attach_audio_mixed_processor,
                                                                                         "attach_audio_mixed_processor")},
            {"detach_audio_mixed_processor",         m_gc->make_immortal<NativeFunction>(detach_audio_mixed_processor,
    ...
    std::unordered_map<std::string, bond::GcPtr<bond::Object>> mod = {
            ...
            {"audio", m_gc->make_immortal<Module>(path, ray_audio)},
